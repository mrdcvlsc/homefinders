      ...
      <div className="search-box">
        <div className="drop-box-container">
          ...
          <select onChange={ e => console.log(e.target.value) }>
            <option key={'default'} value={''} label="N/A"/>
        ...
        <div className="drop-box-container">
          ...
          <select onChange={ e => console.log(e.target.value) }>
            <option key={'default'} value={''} label="N/A"/>
            <option key={'Residential'} value={'Residential'} label="Residential"/>
            <option key={'Semi-Detached'} value={'Semi-Detached'} label="Semi-Detached"/>
          </select>
        </div>
