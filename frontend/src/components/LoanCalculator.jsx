...
export default function LoanCalculator() {
    ...
    const calculateBtnHandler = () => {
        ...
        const newTotalInterestPayable = Math.round(newTotalAmount - loanAmount.current)
        ...
        <div className="loan-calculator-form">
            <div className="loan-calculator-top">
                ...
                <form action="#">
                    <div>
                        ...
                        <input type="number" onChange={(e) => loanAmount.current = e.target.value}/>
                    </div>

                    <div>
                        <div className="loan-calculator-labels">Interest Rate</div>
                        <input type="number" onChange={(e) => interestRate.current = e.target.value}/>
                    </div>

                    <div>
                        <div className="loan-calculator-labels">Tenure (in months)</div>
                        <input type="number" onChange={(e) => loanTenure.current = e.target.value}/>
                    </div>
                </form>
            </div>
            ...
            <div className="loan-calculator-result">
                <div className="loan-calcu-result-left">  
                    ...
                    <button className="loan-calculate-btn" onClick={() => calculateBtnHandler()}>Calculate</button>
                </div>
